...
def main(argv: Optional[List[str]] = None) -> None:
    ...
    df.to_csv(out_dir / "simulation_outputs.csv", index=False, lineterminator="\n")
    ...
    case = decide_weighted_composite(case, weights, threshold=thr_zero_mod,
                                     missing_mode="zero")
    case.to_csv(out_dir / "epic_case_outputs.csv", index=False, lineterminator="\n")
    ...
    if not args.skip_sensitivity:
        ...
        sens_df.to_csv(out_dir / "sensitivity_thresholds.csv", index=False, lineterminator="\n")
        ...
        noise_df.to_csv(out_dir / "sensitivity_noise.csv", index=False, lineterminator="\n")
