...
for p_high in P_HIGH_RISK_LEVELS:
    for p_unsafe_high in P_UNSAFE_HIGH_LEVELS:
        ...
        # composite-moderate at 2.2x gate rate, capped consistently with the main pipeline
        target_mod = min(MODERATE_DEPLOYMENT_CAP, gate_rate * 2.2)
